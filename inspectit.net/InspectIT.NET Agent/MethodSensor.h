...
namespace inspectit {
	namespace sensor {
		...
		public:
			...
			void initialize(std::shared_ptr<inspectit::config::MethodSensorTypeConfig> config, JAVA_LONG platformId, ICorProfilerInfo *profilerInfo, std::shared_ptr<inspectit::sending::DataSendingService> dataSendingService);
